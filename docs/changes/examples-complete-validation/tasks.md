...
- **完成证据**：`target/example-e2e/20260711-073534-69263/`，34 PASS、0 FAIL、0 SKIP、
  0 BLOCKED；1001、1002、2001、2002 端口和两个 Nacos 实例均已清理。
- [x] 完成
...
- **完成证据**：`target/example-e2e/20260711-074039-81648/`，23 PASS、0 FAIL、0 SKIP、
  0 BLOCKED；Redis 限流键和 8000、1001、1002、2001、2002 端口均已清理。
- [x] 完成
...
- **最终证据**：`target/example-e2e/20260711-142401-29430/`，17 PASS、0 FAIL、0 SKIP、
  0 BLOCKED。受控静态页、批量、解析、超时、非法 URL、JS 渲染 DOM 和截图均通过；Playwright
  容器、网络、18085/19222/8085 端口和受管进程全部清理。
- [x] 完成
...
- **最终证据**：`target/example-e2e/20260711-143510-53906/`，19 PASS、0 FAIL、0 SKIP、
  0 BLOCKED。两个用户完成连接通知、聊天广播、REST 广播、按用户、按会话、心跳和断开状态验证；
  前端 `npm ci`、生产构建、Playwright UI 和应用内浏览器复核通过，3000/8086 端口已释放。
- [x] 完成
...
- **当前证据**：`target/example-e2e/20260711-144556-75187/`，11 PASS、0 FAIL、0 SKIP、
  1 BLOCKED。隔离 MySQL、后端、授权地址、错误回调、未登录、前端构建和清理通过；Vocoor 提供方
  不可达，外部仓库依赖现有业务中间件，未在非隔离条件下冒险启动，因此本任务保持未完成。
- [ ] 完成
