...
public class DataPersistenceAutoConfiguration {
    ...
    public SqlSessionFactory sqlSessionFactory(
        ...
        // 获取配置属性（使用默认值如果未配置）
        MybatisPlusProperties props = mybatisPlusProperties != null ? mybatisPlusProperties
        ...
        if (StringUtils.hasText(mapperLocations)) {
            ...
            try {
                ...
                log.debug("No mapper XML files found at {}, which is fine for annotation-based mappers",
                        mapperLocations);
            }
        }
