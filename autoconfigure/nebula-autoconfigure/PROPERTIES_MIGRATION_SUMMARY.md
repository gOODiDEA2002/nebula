...
在之前的架构设计中，我们将所有 AutoConfiguration 类和 Properties 类都迁移到了 `nebula-autoconfigure` 模块然而，这导致了**循环依赖**问题：
...
通过将 Properties 类回退到各自的功能模块，我们成功解决了循环依赖问题，同时保持了架构的清晰性和可维护性这种设计遵循了 Spring Boot 的最佳实践，为后续的功能扩展和维护奠定了良好的基础
