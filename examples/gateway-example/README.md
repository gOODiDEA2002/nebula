...
- user-service 和 order-service 已启动（参考 [microservice-example](../microservice-example/README.md)）
...
# 2. 确保 Nacos 和 Redis 已启动

# 3. 启动 user-service（端口 1001）
mvn -q -f examples/microservice-example/user-service spring-boot:run

# 4. 启动 order-service（端口 1002）
...
- [nebula-starter-gateway](../../starter/nebula-starter-gateway/pom.xml)
- [微服务示例](../microservice-example/README.md)
